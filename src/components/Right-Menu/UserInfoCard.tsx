    ...
    <div className=' p-4 bg-white rounded-lg shadow-md text-sm flex flex-col gap-4'>
        ...
        <div className='flex flex-col gap-4 text-gray-500'>
            <div className='flex items-center gap-2'>
                <span className='text-xl text-black'>{(user?.name && user.surname)? user.name+ " "+ user.surname : user?.surname}</span>
            ...
            {currentUserId && currentUserId!==user?.clerkId && (<UserInfoCardInteraction userId={user?.clerkId} 
